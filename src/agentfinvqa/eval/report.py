...
Usage:
    uv run --env-file .env -m agentfinvqa.eval.report \\
...
<footer>Generated by agentfinvqa &nbsp;·&nbsp; AgentFinVQA Evaluation Framework</footer>
</body>
</html>"""
...
def build_report(
    ...
    taxonomy_rows: list,
    out_path: str,
    title: str = "AgentFinVQA Evaluation Report",
) -> None:
...
def main() -> None:
    ...
    parser.add_argument("--title", default="AgentFinVQA Evaluation Report")
